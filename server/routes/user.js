...
router.get('/get_friends', function(req, res){
    var query = "SELECT friend.friend_id, friend.date_friended, u.username, u.origin FROM user_friends friend INNER JOIN users u ON(u.id = friend.friend_id) WHERE user_id=" + req.user_id;
...
router.get('/get_friend_requests', function(req, res){
    ...
    var query = "SELECT request.id, u.username, u.origin FROM user_friend_requests request INNER JOIN users u ON (u.id = request.received_id) WHERE u.id=" + req.user_id + " AND status='pending'";
...
router.get('/get_users_by_quantity', function(req, res){
    var query = "SELECT id, username, origin FROM users WHERE id != " + req.user_id;
